...
int count_tDBOutput_3=0;
                                ...
                                if(!whetherExist_tDBOutput_3) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_3 = conn_tDBOutput_3.createStatement()) {
                                        stmtCreate_tDBOutput_3.execute("CREATE TABLE \"" + tableName_tDBOutput_3 + "\"(\"patient_id\" SERIAL  not null ,\"person_uuid\" VARCHAR(36)  ,\"gender\" VARCHAR(7)  ,\"marital_status\" VARCHAR(15)  ,\"education\" VARCHAR(25)  ,\"occupation\" VARCHAR(25)  ,\"next_of_kin_relationship\" VARCHAR(50)  ,primary key(\"patient_id\"))");
                                    }
                                }
...
int count_tDBOutput_4=0;
                                ...
                                if(!whetherExist_tDBOutput_4) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_4 = conn_tDBOutput_4.createStatement()) {
                                        stmtCreate_tDBOutput_4.execute("CREATE TABLE \"" + tableName_tDBOutput_4 + "\"(\"patient_id\" SERIAL  not null ,\"person_uuid\" VARCHAR(36)  ,\"gender\" VARCHAR(7)  ,\"marital_status\" VARCHAR(15)  ,\"education\" VARCHAR(25)  ,\"occupation\" VARCHAR(25)  ,\"next_of_kin_relationship\" VARCHAR(50)  ,primary key(\"patient_id\"))");
                                    }
                                }
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/A/Documents/TOS_BD-20200219_1130-V7.3.1/workspace/out.csv")).getAbsolutePath().replace("\\","/");
...
System.out.println("Total facility with data fetched from LAMIS3 DB - "+globalMap.get("tDBInput_12_NB_LINE"));
...
/************************************************************************************************
 *     838157 characters generated by Talend Open Studio for Big Data 
 *     on the October 28, 2022 5:26:58 PM WAT
 ************************************************************************************************/