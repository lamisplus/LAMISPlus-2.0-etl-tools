...
CreatJSON_Field_tmp.first_name = (Patients_mapping.other_names==null)||("".equals(Patients_mapping.other_names))?"":Patients_mapping.other_names ;
CreatJSON_Field_tmp.surname = (Patients_mapping.surname==null)||("".equals(Patients_mapping.surname))?"":Patients_mapping.surname ;
CreatJSON_Field_tmp.other_name = (Patients_mapping.other_names==null)||("".equals(Patients_mapping.other_names))?"":Patients_mapping.other_names ;
...
Employment_tmp.occupation_display = Lamisplus_Employment_codesets_lookup.employment_display ;
...
int count_tDBOutput_3=0;
                                ...
                                if(!whetherExist_tDBOutput_3) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_3 = conn_tDBOutput_3.createStatement()) {
                                        stmtCreate_tDBOutput_3.execute("CREATE TABLE \"" + tableName_tDBOutput_3 + "\"(\"patient_id\" SERIAL  not null ,\"person_uuid\" VARCHAR(36)  ,\"gender\" VARCHAR(7)  ,\"marital_status\" VARCHAR(100)  ,\"education\" VARCHAR(100)  ,\"occupation\" VARCHAR(100)  ,\"next_of_kin_relationship\" VARCHAR(100)  ,primary key(\"patient_id\"))");
                                    }
                                }
...
final_mapper_tmp.sex = (Unique_Patients.sex != null)?(Character.toUpperCase(Unique_Patients.sex.toLowerCase().charAt(0)) + Unique_Patients.sex.toLowerCase().substring(1)):Unique_Patients.sex; ;
final_mapper_tmp.full_name = ((Unique_Patients.first_name == null)?"":Unique_Patients.first_name.trim()) + 
((Unique_Patients.surname == null)?"":Unique_Patients.surname.trim()) ;
...
/************************************************************************************************
 *     797988 characters generated by Talend Open Studio for Big Data 
 *     on the March 18, 2023 6:10:00 PM WAT
 ************************************************************************************************/