 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT h.id as id, json_build_object(\n  'date', hiv_test_result ->> 'screeningTestDate'::varchar, \n'result', \n	(CASE"
+"\n    WHEN lower(trim(left(hiv_test_result ->>'screeningTestResult'::VARCHAR, 2)))='re' THEN 'Yes'\n	WHEN lower(trim(lef"
+"t(hiv_test_result ->>'screeningTestResult'::VARCHAR, 2)))='no' THEN 'No'\n	ELSE\n	null\n  END)\n) test1,\njson_build_obj"
+"ect(\n  'date', hiv_test_result ->> 'confirmatoryTestDate'::varchar, \n'result', \n	(CASE\n    WHEN lower(trim(left(hiv_"
+"test_result ->>'confirmatoryTestResult'::VARCHAR, 2)))='re' THEN 'Yes'\n	WHEN lower(trim(left(hiv_test_result ->>'confir"
+"matoryTestResult'::VARCHAR, 2)))='no' THEN 'No'\n	ELSE\n	null\n  END)	\n) confirmatory_test,\njson_build_object(\n  'dat"
+"e', hiv_test_result ->> 'tieBreakerTestDate'::varchar, \n'result', \n	  (CASE\n    WHEN lower(trim(left(hiv_test_result "
+"->>'tieBreakerTestResult'::VARCHAR, 2)))='re' THEN 'Yes'\n	WHEN lower(trim(left(hiv_test_result ->>'tieBreakerTestResult"
+"'::VARCHAR, 2)))='no' THEN 'No'\n	ELSE\n	null\n  END)	\n) tie_breaker_test, h.date_visit::date, h.archived::integer, \nh"
+".created_at::timestamp as date_created,\nh.updated_at::timestamp as date_modified,\n'ETL' as created_by,\n'ETL' as modif"
+"ied_by,\nh.completed_by as captured_by,\nh.hts_uuid as uuid,\nh.previously_tested,\n  CASE\n    WHEN lower(trim(h.index_"
+"testing))='yes' THEN true\n	WHEN lower(trim(h.index_testing))='no' THEN false\n	ELSE\n	null\n  END \n  AS index_testing,"
+"\nh.number_of_children as num_children,\nh.number_of_wives as num_wives,\n  CASE\n    WHEN lower(trim(h.first_time_visit"
...
+"\n	ELSE\n	lower(trim(left(h.type_of_counseling,4)))\n  END) as type_counseling,\n\nlower(left(h.referred_from,4)) as ref"
+"erred_from,\nlower(left(h.setting,4)) as testing_setting,\nlower(left(h.target_group,4)) as target_group,\njson_build_ob"
+"ject('surname', h.surname,\n				  'first_name', h.first_name,\n				  'middle_name', h.middle_name,\n				  'date_of_birth"
+"', h.date_of_birth::varchar,\n				  'age', h.age,\n				  'gender', h.gender,\n				  'phone_number', h.phone_number,\n			"
+"	  'state_of_residence', s.name,\n				  'lga_of_residence', l.name,\n				  'marital_status', h.marital_status)::jsonb as"
+" extra,\n				  json_build_object('hivTestBefore', '',\n				'hivTestResult', (CASE\n    WHEN lower(trim(left(h.post_test_"
+"counseling->>'hivResult'::VARCHAR, 2)))='po' THEN 'True'\n	WHEN lower(trim(left(h.post_test_counseling->>'hivResult'::VA"
+"RCHAR, 2)))='ne' THEN 'False'\n	ELSE\n	'False'\n  END),\n				'informationFp', h.post_test_counseling->>'providedWithInfo"
+"rmationOnFPAndDualContraception',\n				'riskReduction', h.post_test_counseling->>'riskReductionPlanDeveloped',\n				'cor"
+"rectCondomUse', h.post_test_counseling->>'correctCondomUseDemonstrated',\n				'hivRequestResult', h.post_test_counseling"
+"->>'hivRequestAndResultFormSignedByTester',\n				'childrenHivtesting', h.post_test_counseling->>'willBringOwnChildrenFor"
+"HIVTesting',\n				'hivRequestResultCt', h.post_test_counseling->>'hivRequestAndResultFormFilledWithCTIForm',\n				'partn"
+"erFpUseCondom', h.post_test_counseling->>'clientOrPartnerUseCondomsAsOneFPMethods',\n				'postTestCounseling', h.post_te"
+"st_counseling->>'postTestCounsellingDone',\n				'postTestDisclosure', h.post_test_counseling->>'postTestDisclosurePlanDe"
+"veloped',\n				'referredToServices', h.post_test_counseling->>'clientReferredToOtherServices',\n				'partnerFpThanCondom"
+"', h.post_test_counseling->>'clientOrPartnerUseFPMethodsOtherThanCondoms',\n				'bringPartnerHivtesting', h.post_test_co"
+"unseling->>'willBringPartnerForHIVTesting',\n				'condomProvidedToClient', h.post_test_counseling->>'condomsProvidedToCl"
+"ient',\n				'clientReceivedHivTestResult', h.post_test_counseling->>'clientReceivedHIVTestResult',\n				'unprotectedSexR"
+"egularPartnerLastThreeMonth', h.post_test_counseling->>'testedForHIVBeforeWithinThisYear'\n				) as post_test_counseling"
+",\n				\n				json_build_object('informConsentHivTest', h.pre_test_counseling->'knowledgeAssessment'->>'informedConsentFo"
+"rHIVTestingGiven',\n				'clientInformRiskkHivTrans', h.pre_test_counseling->'knowledgeAssessment'->>'clientInformedOfHIV"
+"TransmissionRiskFactors',\n				'previousTestedHIVNegative', h.pre_test_counseling->'knowledgeAssessment'->> 'previouslyT"
+"estedHIVNegative',\n			  'clientInformHivTransRoutes', h.pre_test_counseling->'knowledgeAssessment'->>'clientInformedAbo"
+"utHIVTransmissionRoutes',\n			  'timeLastHIVNegativeTestResult', '',\n			  'clientInformPossibleTestResult',h.pre_test_c"
+"ounseling->'knowledgeAssessment'->>'clientInformedAboutPossibleTestResults',\n			  'clientInformPreventingsHivTrans', h."
+"pre_test_counseling->'knowledgeAssessment'->>'clientInformedAboutPreventingHIV',\n				'clientPregnant', h.pre_test_couns"
+"eling->'knowledgeAssessment'->>'clientPregnant'\n				)::jsonb as knowledge_assessment,\n				\n				json_build_object('fev"
+"er',  h.pre_test_counseling->'clinicalTBScreening'->>'fever',\n    'weightLoss', h.pre_test_counseling->'clinicalTBScree"
+"ning'->>'weightLoss',\n    'nightSweats', h.pre_test_counseling->'clinicalTBScreening'->>'nightSweats',\n    'currentlyC"
+"ough', h.pre_test_counseling->'clinicalTBScreening'->>'currentlyCough',\n    'lymphadenopath', h.pre_test_counseling->'c"
+"linicalTBScreening'->>'lymphadenopath'\n	) as tb_screening,\n	\n	json_build_object('scrotalSwellingAndPain',  h.pre_test"
+"_counseling->'syndromicSTIScreening'->>'scrotalSwellingAndPain',\n    'genitalSoreOrSwollenInguinalLymphNodes', h.pre_te"
+"st_counseling->'syndromicSTIScreening'->>'genitalSoreOrSwollenInguinalLymphNodes',\n    'vaginalDischargeOrBurningWhenUr"
+"inating', h.pre_test_counseling->'syndromicSTIScreening'->>'vaginalDischargeOrBurningWhenUrinating',\n    'urethralDisch"
+"argeOrBurningWhenUrinating', h.pre_test_counseling->'syndromicSTIScreening'->>'urethralDischargeOrBurningWhenUrinating',"
+"\n    'lowerAbdominalPainsWithOrWithoutVaginalDischarge', h.pre_test_counseling->'syndromicSTIScreening'->>'lowerAbdomin"
+"alPainsWithOrWithoutVaginalDischarge'\n	) as sti_screening,\n	\n	json_build_object('stiInLast3Months',  h.pre_test_couns"
+"eling->'hivRiskAssessment'->>'stiInLast3Months',\n    'everHadSexualIntercourse', h.pre_test_counseling->'hivRiskAssessm"
+"ent'->>'everHadSexualIntercourse',\n    'bloodTransfusionInLast3Months', h.pre_test_counseling->'hivRiskAssessment'->>'b"
+"loodTransfusionInLast3Months',\n    'moreThan1SexPartnerDuringLast3Months', h.pre_test_counseling->'hivRiskAssessment'->"
+">'moreThan1SexPartnerDuringLast3Months',\n    'unprotectedSexWithCasualPartnerInLast3Months', h.pre_test_counseling->'hi"
+"vRiskAssessment'->>'unprotectedSexWithCasualPartnerInLast3Months',\n	'unprotectedSexWithRegularPartnerInLast3Months', h."
+"pre_test_counseling->'hivRiskAssessment'->>'unprotectedSexWithRegularPartnerInLast3Months'\n	) as risk_assessment, \n\nj"
+"son_build_object('optOutRTRI',  h.recency_testing->>'consent',\n    'rencencyId',  h.recency_testing->>'recencyNumber',"
+"\n    'sampleType',  h.recency_testing->>'sampleType',\n    'controlLine',  h.recency_testing->>'controlLine',\n    'hasV"
+"iralLoad',  h.recency_testing->>'viralLoadRequest',\n	'longTermLine',  h.recency_testing->>'viralLoadRequest',\n	'recenc"
+"yResult',  h.recency_testing->>'recencyResult',\n	'sampleTestDate',  h.recency_testing->>'testDate',\n	'receivingPcrLab'"
+",  h.recency_testing->>'pcrLab',\n	'verififcationLine',  h.recency_testing->>'verificationLine',\n	'finalRecencyResult',"
+"  h.recency_testing->>'finalRecencyTestResult',\n	'optOutRTRITestDate',  '',\n	'optOutRTRITestName',  h.recency_testing-"
+">>'testName',\n	'sampleCollectedDate',  h.recency_testing->>'dateSampleCollected',\n	'sampleReferanceNumber',  h.recency"
+"_testing->>'sampleReferenceNumber',\n	'dateSampleSentToPCRLab',  h.recency_testing->>'dateSampleSent',\n	'rencencyInterp"
+"retation',  h.recency_testing->>'recencyInterpretation',\n	'viralLoadResultClassification',  h.recency_testing->>'viralL"
+"oadClassification',\n	'viralLoadConfirmationTestDate',  h.recency_testing->>'viralLoadConfirmationTestDate',\n	'rapidRec"
+"encyAssay',  h.recency_testing->>'rapidRecencyAssay'\n	) as recency,\nn.datim_id\n				  \nfrom hts_new h\nINNER JOIN sta"
+"te s ON h.state_of_residence = s.id\nINNER JOIN lga l ON h.lga_of_residence = l.id\nINNER JOIN ndr_facility n ON n.id=h."
+"facility_id";
...
/************************************************************************************************
 *     315091 characters generated by Talend Open Studio for Big Data 
 *     on the November 6, 2022 1:37:11 PM WAT
 ************************************************************************************************/