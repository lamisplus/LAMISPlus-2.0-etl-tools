...
/**
 * Job: HIV_ART_Clinical Purpose: ETL tool for other clinical encounters<br>
 * Description: This ETL tool is use for migrating other clinical encounters from LAMIS 3 clinic table to LAMISPlus hiv_art_clinical table <br>
...
int count_tDBOutput_3=0;
                                ...
                                if(!whetherExist_tDBOutput_3) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_3 = conn_tDBOutput_3.createStatement()) {
                                        stmtCreate_tDBOutput_3.execute("CREATE TABLE \"" + tableName_tDBOutput_3 + "\"(\"created_date\" TIMESTAMP(29)   not null ,\"created_by\" VARCHAR(100)  ,\"last_modified_date\" TIMESTAMP(29)   not null ,\"last_modified_by\" VARCHAR(100)  ,\"uuid\" VARCHAR(100)  ,\"archived\" INT4 ,\"visit_date\" DATE ,\"cd_4\" FLOAT8 ,\"cd_4_percentage\" FLOAT8 ,\"is_commencement\" BOOL ,\"oi_screened\" VARCHAR(5000)  ,\"sti_ids\" VARCHAR(5000)  ,\"sti_treated\" VARCHAR(5000)  ,\"" + "opportunistic_infections" + "\" VARCHAR(5000),\"adr_screened\" VARCHAR(5000)  ,\"" + "adverse_drug_reactions" + "\" VARCHAR(5000),\"adherence_level\" VARCHAR(5000)  ,\"" + "adheres" + "\" VARCHAR(5000),\"next_appointment\" DATE ,\"lmp_date\" DATE ,\"functional_status\" VARCHAR(500)  ,\"clinical_stage\" VARCHAR(500)  ,\"datim_id\" VARCHAR(100)   not null ,\"hiv_enrollment_uuid\" VARCHAR(255)   not null ,\"visit_id\" VARCHAR(255)   not null ,\"person_uuid\" VARCHAR(255)   not null ,\"id\" INT4 ,\"regimen_id\" BIGSERIAL  not null ,\"regimen_type_id\" INT4  not null ,\"" + "extra" + "\" VARCHAR(5000),\"notes\" VARCHAR(5000)  ,\"tb_status\" INT4 ,\"pregnancy_status\" VARCHAR ,primary key(\"id\"))");
                                    }
                                }
...
/************************************************************************************************
 *     537485 characters generated by Talend Open Studio for Big Data 
 *     on the March 23, 2023 8:44:14 AM WAT
 ************************************************************************************************/