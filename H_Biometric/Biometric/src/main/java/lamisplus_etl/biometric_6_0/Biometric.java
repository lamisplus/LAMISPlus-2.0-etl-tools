...
package lamisplus_etl.biometric_6_0;
...
/**
 * Job: Biometric Purpose: H_Biometric<br>
 * Description: H_Biometric <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Biometric implements TalendJob {
...
public String getLAMIS3_Schema(){
	...
	private final String jobName = "Biometric";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Biometric.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class extract_biometricStruct implements routines.system.IPersistableRow<extract_biometricStruct> {
    final static byte[] commonByteArrayLock_LAMISPLUS_ETL_Biometric = new byte[0];
    static byte[] commonByteArray_LAMISPLUS_ETL_Biometric = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LAMISPLUS_ETL_Biometric.length) {
				if(length < 1024 && commonByteArray_LAMISPLUS_ETL_Biometric.length == 0) {
   					commonByteArray_LAMISPLUS_ETL_Biometric = new byte[1024];
				} else {
   					commonByteArray_LAMISPLUS_ETL_Biometric = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LAMISPLUS_ETL_Biometric, 0, length);
			strReturn = new String(commonByteArray_LAMISPLUS_ETL_Biometric, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LAMISPLUS_ETL_Biometric) {
 ...
 */
    ...
    public static void main(String[] args){
        final Biometric BiometricClass = new Biometric();

        int exitCode = BiometricClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Biometric.class.getClassLoader().getResourceAsStream("lamisplus_etl/biometric_6_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Biometric.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Biometric");
        }
...
/************************************************************************************************
 *     119885 characters generated by Talend Open Studio for Big Data 
 *     on the November 13, 2022 10:30:17 PM WAT
 ************************************************************************************************/