...
package lamisplus_etl.biometric_version_20_6_0;
...
/**
 * Job: Biometric_Version_20 Purpose: H_Biometric<br>
 * Description: H_Biometric <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Biometric_Version_20 implements TalendJob {
...
public String getLAMIS3_Schema(){
	...
	private final String jobName = "Biometric_Version_20";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Biometric_Version_20.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Biometric_Version_20.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class extract_biometricStruct implements routines.system.IPersistableRow<extract_biometricStruct> {
    final static byte[] commonByteArrayLock_LAMISPLUS_ETL_Biometric_Version_20 = new byte[0];
    static byte[] commonByteArray_LAMISPLUS_ETL_Biometric_Version_20 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LAMISPLUS_ETL_Biometric_Version_20.length) {
				if(length < 1024 && commonByteArray_LAMISPLUS_ETL_Biometric_Version_20.length == 0) {
   					commonByteArray_LAMISPLUS_ETL_Biometric_Version_20 = new byte[1024];
				} else {
   					commonByteArray_LAMISPLUS_ETL_Biometric_Version_20 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LAMISPLUS_ETL_Biometric_Version_20, 0, length);
			strReturn = new String(commonByteArray_LAMISPLUS_ETL_Biometric_Version_20, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LAMISPLUS_ETL_Biometric_Version_20) {
 ...
 */
    ...
    public static void main(String[] args){
        final Biometric_Version_20 Biometric_Version_20Class = new Biometric_Version_20();

        int exitCode = Biometric_Version_20Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Biometric_Version_20.class.getClassLoader().getResourceAsStream("lamisplus_etl/biometric_version_20_6_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Biometric_Version_20.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Biometric_Version_20");
        }
...
/************************************************************************************************
 *     122222 characters generated by Talend Open Studio for Big Data 
 *     on the December 8, 2022 12:01:15 AM WAT
 ************************************************************************************************/