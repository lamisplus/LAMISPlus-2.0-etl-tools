...
package lamisplus_etl.biometric_neurotec_version_20_6_0;
...
/**
 * Job: Biometric_Neurotec_Version_20 Purpose: H_Biometric<br>
 * Description: H_Biometric <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Biometric_Neurotec_Version_20 implements TalendJob {
...
public String getLAMIS3_Schema(){
	...
	private final String jobName = "Biometric_Neurotec_Version_20";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Biometric_Neurotec_Version_20.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Biometric_Neurotec_Version_20.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class extract_biometricStruct implements routines.system.IPersistableRow<extract_biometricStruct> {
    final static byte[] commonByteArrayLock_LAMISPLUS_ETL_Biometric_Neurotec_Version_20 = new byte[0];
    static byte[] commonByteArray_LAMISPLUS_ETL_Biometric_Neurotec_Version_20 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LAMISPLUS_ETL_Biometric_Neurotec_Version_20.length) {
				if(length < 1024 && commonByteArray_LAMISPLUS_ETL_Biometric_Neurotec_Version_20.length == 0) {
   					commonByteArray_LAMISPLUS_ETL_Biometric_Neurotec_Version_20 = new byte[1024];
				} else {
   					commonByteArray_LAMISPLUS_ETL_Biometric_Neurotec_Version_20 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LAMISPLUS_ETL_Biometric_Neurotec_Version_20, 0, length);
			strReturn = new String(commonByteArray_LAMISPLUS_ETL_Biometric_Neurotec_Version_20, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LAMISPLUS_ETL_Biometric_Neurotec_Version_20) {
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id\",\"person_uuid\",\"facility_id\",\"template_type\",\"biometric_type\",\"enrollment_date\",\"created_date\",\"last_modified_date\",\"template\",\"archived\",\"iso\",\"version_iso_20\",\"created_by\",\"last_modified_by\",\"device_name\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"id\" = ?,\"person_uuid\" = ?,\"facility_id\" = ?,\"template_type\" = ?,\"biometric_type\" = ?,\"enrollment_date\" = ?,\"created_date\" = ?,\"last_modified_date\" = ?,\"template\" = ?,\"archived\" = ?,\"iso\" = ?,\"version_iso_20\" = ?,\"created_by\" = ?,\"last_modified_by\" = ?,\"device_name\" = ? WHERE \"id\" = ?";
...
+"ed, template, archived::integer, iso, \nnf.datim_id, version_iso_20, 'Neurotec' AS device_name\n	FROM biometric b\n	INNE"
+"R JOIN ndr_facility nf\n  ON nf.id=b.facility_id";
        	...
        	biometric_record.device_name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
		                    }
...
extract_biometric_tmp.device_name = biometric_record.device_name ;
...
} else {pstmtInsert_tDBOutput_1.setBoolean(12, extract_biometric.version_iso_20);
}

                        if(extract_biometric.created_by == null) {
pstmtInsert_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(13, extract_biometric.created_by);
}

                        if(extract_biometric.last_modified_by == null) {
pstmtInsert_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(14, extract_biometric.last_modified_by);
}

                        if(extract_biometric.device_name == null) {
pstmtInsert_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(15, extract_biometric.device_name);
}
...
System.out.println("*************BIOMETRIC(NEUROTEC) MIGRATION REPORT END*****************");
System.out.println("****************************************************************");
...
System.out.println("*****************************************************************");
System.out.println("***********BIOMETRIC(NEUROTEC) MIGRATION REPORT START*****************");
 ...
 */
    ...
    public static void main(String[] args){
        final Biometric_Neurotec_Version_20 Biometric_Neurotec_Version_20Class = new Biometric_Neurotec_Version_20();

        int exitCode = Biometric_Neurotec_Version_20Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Biometric_Neurotec_Version_20.class.getClassLoader().getResourceAsStream("lamisplus_etl/biometric_neurotec_version_20_6_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Biometric_Neurotec_Version_20.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Biometric_Neurotec_Version_20");
        }
...
/************************************************************************************************
 *     123626 characters generated by Talend Open Studio for Big Data 
 *     on the February 24, 2023 10:52:23 AM WAT
 ************************************************************************************************/