 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT s.id, s.last_modified as created_date, 'ETL' as created_by, \ns.last_modified as last_modified_date,'ETL' as las"
+"t_modified_by,\np.uuid as person_id, s.status as hiv_status, s.date_status as status_date,\ns.outcome as tracking_outcom"
+"e, s.date_tracked as track_date, s.agreed_date,\ns.reason_for_interruption, s.cause_of_death, s.auto, s.uuid,\ns.archive"
+"d::integer as archived, nf.datim_id\nFROM status_history s\nINNER JOIN patient p ON s.patient_id = p.id\nINNER JOIN ndr_"
+"facility nf ON s.facility_id = nf.id";
...
System.out.println("Total status tracker records fetched from LAMIS3 status_tracker - "+globalMap.get("tDBInput_1_NB_LINE"));
...
/************************************************************************************************
 *     152790 characters generated by Talend Open Studio for Big Data 
 *     on the November 13, 2022 10:33:01 PM WAT
 ************************************************************************************************/