...
+"t_id as p_id, MAX(date_status) AS MAXDATE\n   FROM status_history WHERE archived=FALSE\n   GROUP BY patient_id\nORDER BY"
+" patient_id ASC\n) sh2 ON sh1.patient_id = sh2.p_id AND sh1.date_status = sh2.MAXDATE AND sh1.archived=FALSE\nINNER JOIN"
+" patient p ON sh1.patient_id = p.id\nINNER JOIN ndr_facility nf ON sh1.facility_id = nf.id\nORDER BY sh1.patient_id ASC";
...
/************************************************************************************************
 *     173495 characters generated by Talend Open Studio for Big Data 
 *     on the March 28, 2023 5:17:14 PM WAT
 ************************************************************************************************/