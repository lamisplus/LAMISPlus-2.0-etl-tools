...
package lamisplus_etl.prep_clinic_6_0;
...
/**
 * Job: PrEP_Clinic Purpose: PrEP_Clinic<br>
 * Description: PrEP_Clinic <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class PrEP_Clinic implements TalendJob {
...
public String getLAMISPlus_Database(){
	...
	private final String jobName = "PrEP_Clinic";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(PrEP_Clinic.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class prep_oneStruct implements routines.system.IPersistableRow<prep_oneStruct> {
	...
	public boolean equals(Object obj) {
		...
		final prep_oneStruct other = (prep_oneStruct) obj;
	...
	public void copyDataTo(prep_oneStruct other) {
	...
	public void copyKeysDataTo(prep_oneStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(prep_oneStruct other) {
...
prep_oneStruct prep_one = new prep_oneStruct();
	...
	currentComponent="tDBOutput_3";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"prep_one");
					}
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	tableName_tDBOutput_3 = ("prep_clinic");
} else {
	tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "\".\"" + ("prep_clinic");
}
...
prep_oneStruct prep_one_tmp = new prep_oneStruct();
// ###############################
...
+"_replace((case when length(split_part(c.bp, '/', 2))>1 then cast(split_part(c.bp, '/', 2)as varchar) else null end), '"
...
+"T(pr_ph.refill_period AS INTEGER) as duration,\n  (CASE WHEN c.pregnant IS NULL THEN NULL\n  WHEN c.pregnant IS true THE"
+"N 'PREGANACY_STATUS_PREGNANT'\n  ELSE 'PREGANACY_STATUS_NOT_PREGNANT'\n  END) pregnant,\n    n.datim_id AS datim_id\n   "
+" FROM clinic c \n    INNER JOIN patient p \n    ON p.id=c.patient_id\n	LEFT JOIN pharmacy ph ON ph.patient_id=c.patient_"
+"id AND ph.date_visit = c.date_visit\n    INNER JOIN ndr_facility n \n    ON n.id=p.facility_id\n	LEFT JOIN regimen r ON "
+"r.id=c.regimen_id\n	LEFT JOIN (SELECT DISTINCT id, arr.line->>'duration'::VARCHAR as refill_period\nFROM pharmacy,\njson"
+"b_array_elements(lines) with ordinality arr(line, position)) pr_ph ON pr_ph.id=ph.id\nWHERE p.extra->>'art'!='true'\nGRO"
+"UP BY p.uuid, c.id, c.uuid, c.date_visit, r.description, c.last_modified, c.extra,\npr_ph.refill_period, n.datim_id";
            ...
            row2.archived = rs_tDBInput_1.getInt(10);
            if(rs_tDBInput_1.wasNull()){
                    row2.archived = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row2.body_weight = null;
							} else {
	                         		
            row2.body_weight = rs_tDBInput_1.getDouble(11);
            if(rs_tDBInput_1.wasNull()){
                    row2.body_weight = null;
            }
		                    }
            ...
            row2.systolic = rs_tDBInput_1.getDouble(12);
            if(rs_tDBInput_1.wasNull()){
                    row2.systolic = null;
            }
		                    }
            ...
            row2.diastolic = rs_tDBInput_1.getDouble(13);
            if(rs_tDBInput_1.wasNull()){
                    row2.diastolic = null;
            }
		                    }
            ...
            row2.height = rs_tDBInput_1.getDouble(14);
            if(rs_tDBInput_1.wasNull()){
                    row2.height = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row2.is_commencement = false;
							} else {
	                         		
            row2.is_commencement = rs_tDBInput_1.getBoolean(15);
            if(rs_tDBInput_1.wasNull()){
			...
			row2.next_appointment = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 16);
		                    }
							if(colQtyInRs_tDBInput_1 < 17) {
								row2.description = null;
							} else {
	                         		
        	row2.description = routines.system.JDBCUtil.getString(rs_tDBInput_1, 17, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 18) {
								row2.adherence_level = null;
							} else {
...
// # Output table : 'prep_one'
prep_one_tmp.person_uuid = row2.person_uuid ;
prep_one_tmp.encounter_date = row2.encounter_date ;
prep_one_tmp.date_prep_given = row2.date_prep_given ;
prep_one_tmp.date_created = row2.date_created ;
prep_one_tmp.date_modified = row2.date_modified;
prep_one_tmp.created_by = row2.created_by ;
prep_one_tmp.modified_by = row2.modified_by ;
prep_one_tmp.uuid = row2.uuid ;
prep_one_tmp.archived = row2.archived ;
prep_one_tmp.weight = row2.body_weight ;
prep_one_tmp.systolic = row2.systolic ;
prep_one_tmp.diastolic = row2.diastolic ;
prep_one_tmp.height = row2.height ;
prep_one_tmp.is_commencement = row2.is_commencement ;
prep_one_tmp.next_appointment = row2.next_appointment ;
...
if(prep_one != null) { 
	...
	currentComponent="tDBOutput_3";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"prep_one");
					}
        ...
        whetherReject_tDBOutput_3 = false;
                    if(prep_one.person_uuid == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, prep_one.person_uuid);
}

                    if(prep_one.encounter_date != null) {
pstmt_tDBOutput_3.setTimestamp(2, new java.sql.Timestamp(prep_one.encounter_date.getTime()));
} else {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.TIMESTAMP);
}

                    if(prep_one.date_prep_given != null) {
pstmt_tDBOutput_3.setTimestamp(3, new java.sql.Timestamp(prep_one.date_prep_given.getTime()));
} else {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.TIMESTAMP);
}

                    if(prep_one.date_created != null) {
pstmt_tDBOutput_3.setTimestamp(4, new java.sql.Timestamp(prep_one.date_created.getTime()));
} else {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.TIMESTAMP);
}

                    if(prep_one.date_modified != null) {
pstmt_tDBOutput_3.setTimestamp(5, new java.sql.Timestamp(prep_one.date_modified.getTime()));
} else {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.TIMESTAMP);
}

                    if(prep_one.created_by == null) {
pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(6, prep_one.created_by);
}

                    if(prep_one.modified_by == null) {
pstmt_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(7, prep_one.modified_by);
}

                    if(prep_one.uuid == null) {
pstmt_tDBOutput_3.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(8, prep_one.uuid);
}

                    pstmt_tDBOutput_3.setInt(9, prep_one.archived);

                    if(prep_one.weight == null) {
pstmt_tDBOutput_3.setNull(10, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_3.setDouble(10, prep_one.weight);
}

                    if(prep_one.systolic == null) {
pstmt_tDBOutput_3.setNull(11, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_3.setDouble(11, prep_one.systolic);
}

                    if(prep_one.diastolic == null) {
pstmt_tDBOutput_3.setNull(12, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_3.setDouble(12, prep_one.diastolic);
}

                    if(prep_one.height == null) {
pstmt_tDBOutput_3.setNull(13, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_3.setDouble(13, prep_one.height);
}

                    pstmt_tDBOutput_3.setBoolean(14, prep_one.is_commencement);

                    if(prep_one.next_appointment != null) {
pstmt_tDBOutput_3.setTimestamp(15, new java.sql.Timestamp(prep_one.next_appointment.getTime()));
} else {
pstmt_tDBOutput_3.setNull(15, java.sql.Types.TIMESTAMP);
}

                    if(prep_one.adherence_level == null) {
pstmt_tDBOutput_3.setNull(16, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(16, prep_one.adherence_level);
}

                    if(prep_one.duration == null) {
pstmt_tDBOutput_3.setNull(17, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(17, prep_one.duration);
}

                    if(prep_one.pregnant == null) {
pstmt_tDBOutput_3.setNull(18, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(18, prep_one.pregnant);
}

                    if(prep_one.visit_uuid == null) {
pstmt_tDBOutput_3.setNull(19, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(19, prep_one.visit_uuid);
}

                    pstmt_tDBOutput_3.setInt(20, prep_one.id);

                    if(prep_one.facility_id == null) {
pstmt_tDBOutput_3.setNull(21, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(21, prep_one.facility_id);
}

                    pstmt_tDBOutput_3.setLong(22, prep_one.regimen_id);
 ...
 */
	...
	nb_line_rejected_tDBOutput_3=nb_line_rejected_tDBOutput_3 + rejectedCount_tDBOutput_3;
        ...
        globalMap.put("tDBOutput_3_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_3);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"prep_one");
			  	}
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = context.LAMISPlus_Password; 
		    ...
		    String dbquery_tDBInput_3 = "SELECT pg_catalog.setval('prep_clinic_id_seq', (SELECT MAX(id) FROM prep_clinic), true)";
...
sequence_extra_tmp.table_name = "prep_clinic";
...
System.out.println("Total PrEP clinc already migrated "+totalMigrated);
...
System.out.println("*************PREP_CLINIC MIGRATION REPORT END*****************");
System.out.println("****************************************************************");
...
System.out.println("*****************************************************************");
System.out.println("***********PREP_CLINIC MIGRATION REPORT START*****************");
...
public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.regimen == null) ? 0 : this.regimen.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row5Struct other = (row5Struct) obj;
						...
						} else if (!this.regimen.equals(other.regimen))
    ...
    public int compareTo(row5Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.regimen, other.regimen);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = context.LAMISPlus_Password; 
		    ...
		    String dbquery_tDBInput_2 = "SELECT id, regimen FROM prep_regimen";
 ...
 */
    ...
    public static void main(String[] args){
        final PrEP_Clinic PrEP_ClinicClass = new PrEP_Clinic();

        int exitCode = PrEP_ClinicClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = PrEP_Clinic.class.getClassLoader().getResourceAsStream("lamisplus_etl/prep_clinic_6_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = PrEP_Clinic.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : PrEP_Clinic");
        }
...
/************************************************************************************************
 *     197630 characters generated by Talend Open Studio for Big Data 
 *     on the February 8, 2023 9:14:15 AM WAT
 ************************************************************************************************/